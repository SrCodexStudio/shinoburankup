...
class RankRepository(private val plugin: JavaPlugin) {
    ...
    private fun parseRequirements(section: ConfigurationSection?): RankRequirements {
        ...
        return RankRequirements(
            ...
            minPlayerKills = section.getInt("min-player-kills", 0),
            minMobKills = section.getInt("min-mob-kills", 0),
            placeholders = section.getConfigurationSection("placeholders")?.let { pSec ->
