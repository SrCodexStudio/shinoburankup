...
data class RankData(
    ...
    /** Base64 skull texture for custom player head display in GUI */
...
data class RankRequirements(
    ...
    val minPlayerKills: Int = 0,      // PvP kills only
    val minMobKills: Int = 0,         // PvE kills only
    val placeholders: Map<String, String> = emptyMap()  // PAPI requirements (e.g. "%statistic_mob_kills%" to ">=100")
)
